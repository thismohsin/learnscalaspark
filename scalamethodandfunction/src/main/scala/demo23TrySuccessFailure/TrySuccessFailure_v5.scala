...
object TrySuccessFailure5 extends App {
  ...
  val records = readCSVFile("/Users/i509335/project/begin-scala/scalamethodandfunction/src/main/scala/demo23TrySuccessFailure/dividendStocks.csv")
